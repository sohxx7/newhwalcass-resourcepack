...
선택한 v2 여의봉(256큐브), 경량화 긴고아(298큐브), 근두운(292큐브)을 추가했습니다. 긴고아는 기존 786큐브에서 62.09% 줄였으며 금색 입체 장식과 착용 크기를 유지합니다. [Wukong 원본과 미리보기](Wukong/README.md), [지급 명령과 사용 방법](docs/wukong.md)을 참고하세요.
